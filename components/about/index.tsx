...
export function About() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="flex h-screen items-center bg-surface1-light dark:bg-brand-dark"
    >
      <div className="flex flex-1 justify-center">
        ...
        <Transition
          ...
          enterTo="opacity-100"
        >
          <div className="mx-2 flex overflow-hidden bg-black shadow-xl md:mx-8 md:rounded-full md:border-8 md:border-surface2-light md:dark:border-surface3-dark lg:mt-8 lg:h-[30em] lg:w-[30em]">
      ...
      <div className="mx-8 flex-1">
        ...
        >
          <h1>
            <p className="font-bold text-text1-light dark:text-text1-dark">
              Hello, I am{" "}
              <span className="text-brand-light dark:text-text1-dark">
                Estevão Gomes.
              </span>
            </p>
          </h1>
          <h2 className="text-sm md:text-2xl">
            <p className="mt-4 text-text2-light dark:text-text2-dark">
